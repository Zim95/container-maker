...
dev_setup:
	./scripts/k8s/development/k8s-development-setup.sh $(NAMESPACE) $(HOST_DIR) $(REPO_NAME) $(REPO_PASSWORD) $(INGRESS_HOST) $(STORAGE_LAYER)
...
prod_setup:
	./scripts/k8s/deployment/k8s-development-setup.sh $(NAMESPACE) $(REPO_NAME) $(REPO_PASSWORD)
